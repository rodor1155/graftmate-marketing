...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 h-64 w-64 rounded-full bg-warm/5 blur-[80px]" />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <h1 className="mt-6 font-display text-4xl font-bold leading-[1.08] tracking-tight text-foreground sm:text-5xl lg:text-[3.25rem]">
              Quote by speaking.{" "}
              <span className="text-accent-bright">Invoice in one tap.</span>
            </h1>
...
function VoiceDemo() {
  return (
    <div className="relative mx-auto w-full max-w-md lg:max-w-none">
      <div className="absolute -inset-4 rounded-2xl bg-gradient-to-br from-accent/20 via-transparent to-warm/10 blur-xl" />
      <div className="relative overflow-hidden rounded-2xl border border-border bg-surface-raised shadow-2xl shadow-black/40">
        ...
        <div className="space-y-4 p-5 sm:p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="rounded-2xl rounded-tl-sm bg-accent/15 px-4 py-3 text-sm leading-relaxed text-foreground">
          ...
          <div className="flex justify-center">
            <span className="rounded-full border border-border bg-surface px-3 py-1 text-[10px] font-medium uppercase tracking-wider text-accent-bright">
          ...
          <button
            type="button"
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-accent py-3 text-sm font-semibold text-[#0a0a0b] transition-colors hover:bg-accent-bright"
          >
            Convert to invoice
            <ArrowIcon />
          </button>
